...
namespace Tavenem.Mathematics.Decimals
{
    ...
    public struct Matrix3x2 : IEquatable<Matrix3x2>
    {
        ...
        public Matrix3x2(decimal m11, decimal m12,
                         decimal m21, decimal m22,
                         decimal m31, decimal m32)
        {
            M11 = m11;
            M12 = m12;
            M21 = m21;
        ...
        /// <returns>A translation matrix.</returns>
        public static Matrix3x2 CreateTranslation(decimal xPosition, decimal yPosition)
        ...
        public static Matrix3x2 CreateScale(decimal xScale, decimal yScale)
        ...
        /// <returns>A scaling matrix.</returns>
        public static Matrix3x2 CreateScale(decimal xScale, decimal yScale, Vector2 centerPoint)
        ...
        /// <returns>A scaling matrix.</returns>
        public static Matrix3x2 CreateScale(decimal scale)
        ...
        /// <param name="centerPoint">The center offset.</param>
        /// <returns>A scaling matrix.</returns>
        public static Matrix3x2 CreateScale(decimal scale, Vector2 centerPoint)
        ...
        public static Matrix3x2 CreateSkew(decimal radiansX, decimal radiansY)
            => new(1, (decimal)Math.Tan((double)radiansY), (decimal)Math.Tan((double)radiansX), 1, 0, 0);
        ...
        /// <param name="centerPoint">The center point.</param>
        /// <returns>A skew matrix.</returns>
        public static Matrix3x2 CreateSkew(decimal radiansX, decimal radiansY, Vector2 centerPoint)
        {
            var xTan = (decimal)Math.Tan((double)radiansX);
            var yTan = (decimal)Math.Tan((double)radiansY);
        ...
        public static Matrix3x2 CreateRotation(decimal radians)
        {
            radians = (decimal)Math.IEEERemainder((double)radians, DoubleConstants.TwoPI);

            decimal c, s;

            const decimal Epsilon = 0.001m * DecimalConstants.PIOver180;     // 0.1% of a degree
            ...
            else if (radians is > (DecimalConstants.HalfPI - Epsilon) and < (DecimalConstants.HalfPI + Epsilon))
            {
                // Exact case for 90 degree rotation.
                c = 0;
                s = 1;
            }
            else if (radians is < (-DecimalConstants.PI + Epsilon) or > (DecimalConstants.PI - Epsilon))
            {
            ...
            {
                // Arbitrary rotation.
                c = (decimal)Math.Cos((double)radians);
                s = (decimal)Math.Sin((double)radians);
            }
        ...
        /// <param name="centerPoint">The center point.</param>
        /// <returns>A rotation matrix.</returns>
        public static Matrix3x2 CreateRotation(decimal radians, Vector2 centerPoint)
        {
            radians = (decimal)Math.IEEERemainder((double)radians, DoubleConstants.TwoPI);
        ...
        public static Matrix3x2 Lerp(Matrix3x2 matrix1, Matrix3x2 matrix2, decimal amount) => new(
            // First row
        ...
        /// </remarks>
        public decimal GetDeterminant() => (M11 * M22) - (M21 * M12);
        ...
        public static Matrix3x2 Multiply(Matrix3x2 value1, decimal value2) => new(
            value1.M11 * value2,
            value1.M12 * value2,
            value1.M21 * value2,
            value1.M22 * value2,
        ...
        /// <param name="value2">The scaling value to use.</param>
        /// <returns>The resulting matrix.</returns>
        public static Matrix3x2 operator *(Matrix3x2 value1, decimal value2) => new(
            value1.M11 * value2,
            value1.M12 * value2,
            value1.M21 * value2,
            value1.M22 * value2,
        ...
        public static implicit operator Matrix3x2(System.Numerics.Matrix3x2 value)
            => new(
                (decimal)value.M11, (decimal)value.M12,
                (decimal)value.M21, (decimal)value.M22,
                (decimal)value.M31, (decimal)value.M32);
        ...
        /// </summary>
        /// <param name="value">The value to convert.</param>
        public static explicit operator Matrix3x2(Doubles.Matrix3x2 value)
            => new(
                (decimal)value.M11, (decimal)value.M12,
                (decimal)value.M21, (decimal)value.M22,
                (decimal)value.M31, (decimal)value.M32);
