...
namespace Tavenem.Mathematics.Decimals
{
    ...
    public struct Plane : IEquatable<Plane>
    {
        ...
        public Plane(Vector3 normal, decimal d)
        {
            Normal = normal;
            D = d;
        }
        ...
        public static decimal Dot(Plane plane, Vector4 value)
        ...
        public static decimal DotCoordinate(Plane plane, Vector3 value)
            => (plane.Normal.X * value.X)
            + (plane.Normal.Y * value.Y)
            + (plane.Normal.Z * value.Z)
            + plane.D;
        ...
        public static decimal DotNormal(Plane plane, Vector3 value)
            => (plane.Normal.X * value.X)
            + (plane.Normal.Y * value.Y)
            + (plane.Normal.Z * value.Z);
        ...
        public static Plane Normalize(Plane value)
        {
            ...
            if (Math.Abs(f - 1.0m) == 0)
            {
                return value; // It already normalized, so we don't need to further process.
            }

            var fInv = 1.0m / f.Sqrt();
        ...
        public static Plane Transform(Plane plane, Matrix4x4 matrix)
        {
            ...
            decimal x = plane.Normal.X, y = plane.Normal.Y, z = plane.Normal.Z, w = plane.D;
        ...
        public static Plane Transform(Plane plane, Quaternion rotation)
        {
            ...
            var m11 = 1.0m - yy2 - zz2;
            var m21 = xy2 - wz2;
            var m31 = xz2 + wy2;

            var m12 = xy2 + wz2;
            var m22 = 1.0m - xx2 - zz2;
            var m32 = yz2 - wx2;

            var m13 = xz2 - wy2;
            var m23 = yz2 + wx2;
            var m33 = 1.0m - xx2 - yy2;

            decimal x = plane.Normal.X, y = plane.Normal.Y, z = plane.Normal.Z;
        ...
        /// <param name="value">The Vector4.</param>
        /// <returns>The dot product.</returns>
        public decimal Dot(Vector4 value) => Dot(this, value);
        ...
        /// <param name="value">The Vector3.</param>
        /// <returns>The resulting value.</returns>
        public decimal DotCoordinate(Vector3 value) => DotCoordinate(this, value);
        ...
        /// <param name="value">The Vector3.</param>
        /// <returns>The resulting dot product.</returns>
        public decimal DotNormal(Vector3 value) => DotNormal(this, value);
        ...
        public static implicit operator Plane(System.Numerics.Plane value)
            => new((decimal)value.Normal.X, (decimal)value.Normal.Y, (decimal)value.Normal.Z, (decimal)value.D);

        /// <summary>
        /// Converts between implementations of planes.
        /// </summary>
        /// <param name="value">The value to convert.</param>
        public static explicit operator Plane(HugeNumbers.Plane value)
            => new((decimal)value.Normal.X, (decimal)value.Normal.Y, (decimal)value.Normal.Z, (decimal)value.D);
        ...
        /// </summary>
        /// <param name="value">The value to convert.</param>
        public static explicit operator Plane(Doubles.Plane value)
            => new((decimal)value.Normal.X, (decimal)value.Normal.Y, (decimal)value.Normal.Z, (decimal)value.D);
