...
namespace Tavenem.Mathematics.Decimals
{
    ...
    public class Sphere : IShape, IEquatable<Sphere>, ISerializable
    {
        ...
        public decimal ContainingRadius => Radius;
        ...
        /// </remarks>
        [System.Text.Json.Serialization.JsonIgnore]
        public decimal SmallestDimension => Radius;
        ...
        public Sphere(decimal radius) : this(radius, Vector3.Zero) { }
        ...
        public Sphere(decimal radius, Vector3 position)
        {
            Position = position;
            Radius = radius;
            ...
            Volume = DecimalConstants.FourThirdsPI * (decimal)Math.Pow((double)Radius, 3);
        }
        ...
        public IShape ScaleVolume(decimal factor)
        {
            ...
            return factor == 0
                ? new Sphere(0, Position)
                : new Sphere(Radius * (decimal)Math.Pow((double)factor, 1.0 / 3.0), Position);
        }
