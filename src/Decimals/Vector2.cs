...
{
    /// <summary>
    /// A structure encapsulating two decimal precision floating point values.
    /// </summary>
    /// <remarks>
    ...
    public struct Vector2 : IEquatable<Vector2>, IComparable, IComparable<Vector2>, IFormattable
    {
        ...
        /// </summary>
        public static Vector2 One => new(1.0m, 1.0m);

        /// <summary>
        /// Returns the vector (1,0).
        /// </summary>
        public static Vector2 UnitX => new(1.0m, 0.0m);

        /// <summary>
        /// Returns the vector (0,1).
        /// </summary>
        public static Vector2 UnitY => new(0.0m, 1.0m);
        ...
        public Vector2(decimal value) : this(value, value) { }
        ...
        public static decimal Angle(Vector2 value1, Vector2 value2)
            => (decimal)Math.Atan2((double)((value1.X * value2.Y) - (value1.Y * value2.X)), (double)Dot(value1, value2));
        ...
        public static decimal Dot(Vector2 value1, Vector2 value2)
        ...
        public static Vector2 Lerp(Vector2 value1, Vector2 value2, decimal amount)
            => new(
        ...
        public static Vector2 Reflect(Vector2 vector, Vector2 normal)
        {
            ...
            return new Vector2(
                vector.X - (2.0m * dot * normal.X),
                vector.Y - (2.0m * dot * normal.Y));
        }
        ...
        public static Vector2 Rotate(Vector2 vector, decimal angle)
        {
        ...
        /// <returns>The angle between the vectors, in radians.</returns>
        public decimal Angle(Vector2 other) => Angle(this, other);
        ...
        /// <returns>The distance.</returns>
        public decimal Distance(Vector2 other) => Distance(this, other);
        ...
        /// <param name="other">The second point.</param>
        /// <returns>The distance squared.</returns>
        public decimal DistanceSquared(Vector2 other) => DistanceSquared(this, other);
        ...
        /// <param name="other">The second vector.</param>
        /// <returns>The dot product.</returns>
        public decimal Dot(Vector2 other) => Dot(this, other);
        ...
        public decimal LengthSquared() => Dot(this, this);
        ...
        /// </summary>
        /// <param name="angle">An angle, in radians.</param>
        public Vector2 Rotate(decimal angle) => Rotate(this, angle);
        ...
        public static Vector2 Multiply(Vector2 left, decimal right) => left * right;
        ...
        /// <returns>The scaled vector.</returns>
        public static Vector2 Multiply(decimal left, Vector2 right) => left * right;
        ...
        public static Vector2 Divide(Vector2 left, decimal divisor) => left / divisor;
        ...
        /// <param name="right">The source vector.</param>
        /// <returns>The scaled vector.</returns>
        public static Vector2 operator *(decimal left, Vector2 right)
        ...
        /// <param name="right">The scalar value.</param>
        /// <returns>The scaled vector.</returns>
        public static Vector2 operator *(Vector2 left, decimal right)
        ...
        /// <returns>The result of the division.</returns>
        public static Vector2 operator /(Vector2 value1, decimal value2)
        ...
        public static implicit operator Vector2(System.Numerics.Vector2 value)
            => new((decimal)value.X, (decimal)value.Y);
        ...
        /// </summary>
        /// <param name="value">The value to convert.</param>
        public static explicit operator Vector2(Doubles.Vector2 value)
            => new((decimal)value.X, (decimal)value.Y);
