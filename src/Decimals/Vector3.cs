...
{
    /// <summary>
    /// A structure encapsulating three decimal precision floating point values.
    /// </summary>
    /// <remarks>
    ...
    public struct Vector3 : IEquatable<Vector3>, IComparable, IComparable<Vector3>, IFormattable
    {
        ...
        /// </summary>
        public static Vector3 One => new(1.0m, 1.0m, 1.0m);

        /// <summary>
        /// Returns the vector (1,0,0).
        /// </summary>
        public static Vector3 UnitX => new(1.0m, 0.0m, 0.0m);

        /// <summary>
        /// Returns the vector (0,1,0).
        /// </summary>
        public static Vector3 UnitY => new(0.0m, 1.0m, 0.0m);

        /// <summary>
        /// Returns the vector (0,0,1).
        /// </summary>
        public static Vector3 UnitZ => new(0.0m, 0.0m, 1.0m);
        ...
        public Vector3(decimal value) : this(value, value, value) { }
        ...
        public Vector3(Vector2 value, decimal z) : this(value.X, value.Y, z) { }
        ...
        public static decimal Angle(Vector3 value1, Vector3 value2)
            => (decimal)Math.Atan2((double)Cross(value1, value2).Length(), (double)Dot(value1, value2));
        ...
        public static Vector3 Lerp(Vector3 value1, Vector3 value2, decimal amount)
            => new(
        ...
        public static Quaternion RotationTo(Vector3 value1, Vector3 value2)
        {
            ...
            else
            {
                return Quaternion.Normalize(
                    new Quaternion(
                        Cross(value1, value2),
                        (value1.LengthSquared() * value2.LengthSquared()).Sqrt() + Dot(value1, value2)));
            }
        }
        ...
        /// <returns>The angle between the vectors, in radians.</returns>
        public decimal Angle(Vector3 other) => Angle(this, other);
        ...
        /// <returns>The distance.</returns>
        public decimal Distance(Vector3 other) => Distance(this, other);
        ...
        /// <param name="other">The second point.</param>
        /// <returns>The distance squared.</returns>
        public decimal DistanceSquared(Vector3 other) => DistanceSquared(this, other);
        ...
        /// <param name="other">The second vector.</param>
        /// <returns>The dot product.</returns>
        public decimal Dot(Vector3 other) => Dot(this, other);
        ...
        public static Vector3 Multiply(Vector3 left, decimal right) => left * right;
        ...
        /// <returns>The scaled vector.</returns>
        public static Vector3 Multiply(decimal left, Vector3 right) => left * right;
        ...
        public static Vector3 Divide(Vector3 left, decimal divisor) => left / divisor;
        ...
        /// <param name="right">The source vector.</param>
        /// <returns>The scaled vector.</returns>
        public static Vector3 operator *(decimal left, Vector3 right)
        ...
        /// <returns>The result of the division.</returns>
        public static Vector3 operator /(Vector3 value1, decimal value2)
        ...
        public static implicit operator Vector3(System.Numerics.Vector3 value)
            => new((decimal)value.X, (decimal)value.Y, (decimal)value.Z);
        ...
        /// </summary>
        /// <param name="value">The value to convert.</param>
        public static explicit operator Vector3(Doubles.Vector3 value)
            => new((decimal)value.X, (decimal)value.Y, (decimal)value.Z);
