...
namespace Tavenem.Mathematics.Doubles
{
    ...
    public class Cylinder : IShape, IEquatable<Cylinder>, ISerializable
    {
        ...
        public Cylinder(Vector3 axis, double radius) : this(axis, radius, Vector3.Zero) { }
        ...
        public Cylinder(Vector3 axis, double radius, Vector3 position)
        {
            Axis = axis;
            Position = position;
            Radius = radius;
            ...
            Volume = Math.PI * Radius * Radius * axisLength;
        }
        ...
        public IShape ScaleVolume(double factor)
        {
            ...
            else
            {
                ...
                return new Cylinder(Axis * hMultiplier, Radius * Math.Sqrt(hMultiplier), Position);
            }
        }
