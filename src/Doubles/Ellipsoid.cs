...
namespace Tavenem.Mathematics.Doubles
{
    ...
    public class Ellipsoid : IShape, IEquatable<Ellipsoid>, ISerializable
    {
        ...
        public Ellipsoid(double axisX, double axisY, double axisZ)
        ...
        public Ellipsoid(double axisX, double axisY, double axisZ, Vector3 position)
        ...
        public Ellipsoid(double axisX, double axisY, double axisZ, Vector3 position, Quaternion rotation)
        {
            AxisX = axisX;
            AxisY = axisY;
            AxisZ = axisZ;
            ...
            Volume = DoubleConstants.FourThirdsPI * AxisX * AxisY * AxisZ;
        }
        ...
        /// perimeter.</param>
        /// <param name="position">The position of the shape in 3D space.</param>
        public Ellipsoid(double radius, double axis, Vector3 position)
        ...
        /// <param name="position">The position of the shape in 3D space.</param>
        /// <param name="rotation">The rotation of this shape in 3D space.</param>
        public Ellipsoid(double radius, double axis, Vector3 position, Quaternion rotation)
        ...
        public bool IsPointWithin(Vector3 point) =>
            Math.Pow((point.X - Position.X) / AxisX, 2) + Math.Pow((point.Y - Position.Y) / AxisY, 2)
            + Math.Pow((point.Z - Position.Z) / AxisZ, 2) <= 1;
