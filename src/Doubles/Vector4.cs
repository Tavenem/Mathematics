...
namespace Tavenem.Mathematics.Doubles
{
    ...
    public struct Vector4 : IEquatable<Vector4>, IComparable, IComparable<Vector4>, IFormattable
    {
        ...
        public static bool IsZero(Vector4 value) => value.X.IsNearlyZero() && value.Y.IsNearlyZero() && value.Z.IsNearlyZero() && value.W.IsNearlyZero();
        ...
        /// <returns>The distance.</returns>
        public double Distance(Vector4 other) => Distance(this, other);
        ...
        /// <param name="other">The second point.</param>
        /// <returns>The distance squared.</returns>
        public double DistanceSquared(Vector4 other) => DistanceSquared(this, other);
        ...
        /// <returns>The dot product.</returns>
        public double Dot(Vector4 other) => Dot(this, other);
