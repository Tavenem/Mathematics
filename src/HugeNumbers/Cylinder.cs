...
namespace Tavenem.Mathematics.HugeNumbers
{
    ...
    public class Cylinder : IShape, IEquatable<Cylinder>, ISerializable
    {
        ...
        /// </summary>
        public Cylinder() : this(Vector3.Zero, HugeNumber.Zero) { }
        ...
        public Cylinder(Vector3 axis, HugeNumber radius) : this(axis, radius, Vector3.Zero) { }
        ...
        public Cylinder(Vector3 axis, HugeNumber radius, Vector3 position)
        {
            Axis = axis;
            Position = position;
            Radius = radius;
            ...
            SmallestDimension = HugeNumber.Min(axisLength, Radius * 2);

            Volume = HugeNumber.PI * Radius * Radius * axisLength;
        }
        ...
        public IShape ScaleVolume(HugeNumber factor)
        {
            ...
            else
            {
                ...
                return new Cylinder(Axis * hMultiplier, Radius * HugeNumber.Sqrt(hMultiplier), Position);
            }
        }
