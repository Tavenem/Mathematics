...
namespace Tavenem.Mathematics.HugeNumbers
{
    ...
    public class Ellipsoid : IShape, IEquatable<Ellipsoid>, ISerializable
    {
        ...
        /// </summary>
        public Ellipsoid() : this(HugeNumber.Zero, HugeNumber.Zero, HugeNumber.Zero) { }
        ...
        public Ellipsoid(HugeNumber axisX, HugeNumber axisY, HugeNumber axisZ)
        ...
        public Ellipsoid(HugeNumber axisX, HugeNumber axisY, HugeNumber axisZ, Vector3 position)
        ...
        public Ellipsoid(HugeNumber axisX, HugeNumber axisY, HugeNumber axisZ, Vector3 position, Quaternion rotation)
        {
            AxisX = axisX;
            AxisY = axisY;
            AxisZ = axisZ;
            ...
            ContainingRadius = HugeNumber.Max(AxisX, HugeNumber.Max(AxisY, AxisZ));
            ...
            Volume = HugeNumber.FourThirdsPI * AxisX * AxisY * AxisZ;
        }
        ...
        /// perimeter.</param>
        public Ellipsoid(HugeNumber radius, HugeNumber axis)
        ...
        /// perimeter.</param>
        /// <param name="position">The position of the shape in 3D space.</param>
        public Ellipsoid(HugeNumber radius, HugeNumber axis, Vector3 position)
        ...
        /// <param name="position">The position of the shape in 3D space.</param>
        /// <param name="rotation">The rotation of this shape in 3D space.</param>
        public Ellipsoid(HugeNumber radius, HugeNumber axis, Vector3 position, Quaternion rotation)
        ...
        public bool IsPointWithin(Vector3 point) =>
            HugeNumber.Pow((point.X - Position.X) / AxisX, 2) + HugeNumber.Pow((point.Y - Position.Y) / AxisY, 2)
            + HugeNumber.Pow((point.Z - Position.Z) / AxisZ, 2) <= 1;
