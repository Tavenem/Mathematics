...
namespace Tavenem.Mathematics.HugeNumbers
{
    ...
    public interface IShape : IEquatable<IShape>
    {
        ...
        /// </summary>
        HugeNumber ContainingRadius { get; }
        ...
        /// </remarks>
        HugeNumber SmallestDimension { get; }

        /// <summary>
        /// The total volume of the shape. Read-only.
        /// </summary>
        HugeNumber Volume { get; }
        ...
        /// </exception>
        IShape ScaleByDimension(HugeNumber factor);
        ...
        /// <paramref name="factor"/> must be &gt;= 0.
        /// </exception>
        IShape ScaleVolume(HugeNumber factor);
    }
}
