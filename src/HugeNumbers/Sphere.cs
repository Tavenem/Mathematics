...
namespace Tavenem.Mathematics.HugeNumbers
{
    ...
    public class Sphere : IShape, IEquatable<Sphere>, ISerializable
    {
        ...
        public HugeNumber ContainingRadius => Radius;
        ...
        /// </remarks>
        [System.Text.Json.Serialization.JsonIgnore]
        public HugeNumber SmallestDimension => Radius;
        ...
        /// </summary>
        public Sphere() : this(HugeNumber.Zero) { }

        /// <summary>
        /// Initializes a new instance of <see cref="Sphere"/>.
        /// </summary>
        /// <param name="radius">The radius of the <see cref="Sphere"/>.</param>
        public Sphere(HugeNumber radius) : this(radius, Vector3.Zero) { }
        ...
        public Sphere(HugeNumber radius, Vector3 position)
        {
            Position = position;
            Radius = radius;
            ...
            Volume = HugeNumber.FourThirdsPI * Radius.Cube();
        }
        ...
        public IShape ScaleVolume(HugeNumber factor)
        {
            ...
            return factor == 0
                ? new Sphere(0, Position)
                : new Sphere(Radius * HugeNumber.Pow(factor, HugeNumber.Third), Position);
        }
        ...
        private bool Intersects(Line line)
        {
            ...
            else
            {
                ...
                var qm = tmp0 - tmp1;
                var qp = tmp0 + tmp1;
                return qm * qp <= 0 || (qm > 0 && HugeNumber.Abs(a1) < extent);
            }
        }
