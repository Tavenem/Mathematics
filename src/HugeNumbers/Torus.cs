...
namespace Tavenem.Mathematics.HugeNumbers
{
    ...
    public class Torus : IShape, IEquatable<Torus>, ISerializable
    {
        ...
        /// </summary>
        [DataMember(Order = 1)]
        public HugeNumber MajorRadius { get; }

        /// <summary>
        /// The radius of the tube, in meters.
        /// </summary>
        [DataMember(Order = 2)]
        public HugeNumber MinorRadius { get; }
        ...
        /// </summary>
        public Torus() : this(HugeNumber.Zero, HugeNumber.Zero) { }
        ...
        public Torus(HugeNumber majorRadius, HugeNumber minorRadius)
        ...
        public Torus(HugeNumber majorRadius, HugeNumber minorRadius, Vector3 position)
        ...
        public Torus(HugeNumber majorRadius, HugeNumber minorRadius, Vector3 position, Quaternion rotation)
        {
            ...
            SmallestDimension = HugeNumber.Min(MajorRadius, MinorRadius);
            Volume = HugeNumber.TwoPISquared * MajorRadius * HugeNumber.Pow(MinorRadius, 2);
        }

        private Torus(SerializationInfo info, StreamingContext context) : this(
            (HugeNumber?)info.GetValue(nameof(MajorRadius), typeof(HugeNumber)) ?? default,
            (HugeNumber?)info.GetValue(nameof(MinorRadius), typeof(HugeNumber)) ?? default,
        ...
        public bool IsPointWithin(Vector3 point) =>
            HugeNumber.Pow(HugeNumber.Pow(point.X - Position.X, 2) + HugeNumber.Pow(point.Y - Position.Y, 2)
            + HugeNumber.Pow(point.Z - Position.Z, 2) + HugeNumber.Pow(MajorRadius, 2) - HugeNumber.Pow(MinorRadius, 2), 2)
            - (4 * HugeNumber.Pow(MajorRadius, 2) * (HugeNumber.Pow(point.X - Position.X, 2) + HugeNumber.Pow(point.Y - Position.Y, 2))) <= 0;
        ...
        public IShape ScaleVolume(HugeNumber factor)
        {
            ...
            {
                var majMultiplier = HugeNumber.Sqrt(factor);
                return new Torus(MajorRadius * majMultiplier, MinorRadius * HugeNumber.Sqrt(majMultiplier), Position, Rotation);
            }
        }
