...
{
    /// <summary>
    /// A structure encapsulating two HugeNumber precision floating point values.
    /// </summary>
    /// <remarks>
    ...
    public struct Vector2 : IEquatable<Vector2>, IComparable, IComparable<Vector2>, IFormattable
    {
        ...
        public Vector2(HugeNumber value) : this(value, value) { }
        ...
        public Vector2(HugeNumber x, HugeNumber y)
        {
            X = x;
            Y = y;
        }
        ...
        public static Vector2 Abs(Vector2 value)
            => new(HugeNumber.Abs(value.X), HugeNumber.Abs(value.Y));
        ...
        public static HugeNumber Angle(Vector2 value1, Vector2 value2)
            => HugeNumber.Atan2((value1.X * value2.Y) - (value1.Y * value2.X), Dot(value1, value2));
        ...
        public static HugeNumber Distance(Vector2 value1, Vector2 value2)
        ...
        public static HugeNumber DistanceSquared(Vector2 value1, Vector2 value2)
        {
        ...
        public static HugeNumber Dot(Vector2 value1, Vector2 value2)
        ...
        /// langword="false"/>.</returns>
        public static bool IsZero(Vector2 value) => value.X == 0 && value.Y == 0;
        ...
        public static Vector2 Lerp(Vector2 value1, Vector2 value2, HugeNumber amount)
            => new(
        ...
        public static Vector2 Rotate(Vector2 vector, HugeNumber angle)
        {
            var sin = HugeNumber.Sin(angle);
            var cos = HugeNumber.Cos(angle);
            return new Vector2(
        ...
        /// <returns>The angle between the vectors, in radians.</returns>
        public HugeNumber Angle(Vector2 other) => Angle(this, other);
        ...
        /// <returns>The distance.</returns>
        public HugeNumber Distance(Vector2 other) => Distance(this, other);
        ...
        /// <param name="other">The second point.</param>
        /// <returns>The distance squared.</returns>
        public HugeNumber DistanceSquared(Vector2 other) => DistanceSquared(this, other);
        ...
        /// <param name="other">The second vector.</param>
        /// <returns>The dot product.</returns>
        public HugeNumber Dot(Vector2 other) => Dot(this, other);
        ...
        public HugeNumber LengthSquared() => Dot(this, this);
        ...
        /// </summary>
        /// <param name="angle">An angle, in radians.</param>
        public Vector2 Rotate(HugeNumber angle) => Rotate(this, angle);
        ...
        public static Vector2 Multiply(Vector2 left, HugeNumber right) => left * right;
        ...
        /// <returns>The scaled vector.</returns>
        public static Vector2 Multiply(HugeNumber left, Vector2 right) => left * right;
        ...
        public static Vector2 Divide(Vector2 left, HugeNumber divisor) => left / divisor;
        ...
        /// <param name="right">The source vector.</param>
        /// <returns>The scaled vector.</returns>
        public static Vector2 operator *(HugeNumber left, Vector2 right)
        ...
        /// <param name="right">The scalar value.</param>
        /// <returns>The scaled vector.</returns>
        public static Vector2 operator *(Vector2 left, HugeNumber right)
        ...
        /// <returns>The result of the division.</returns>
        public static Vector2 operator /(Vector2 value1, HugeNumber value2)
        ...
        /// </summary>
        /// <param name="value">The value to convert.</param>
        public static implicit operator Vector2(Doubles.Vector2 value)
            => new(value.X, value.Y);
        ...
        public static explicit operator Vector2(Decimals.Vector2 value)
            => new((HugeNumber)value.X, (HugeNumber)value.Y);
