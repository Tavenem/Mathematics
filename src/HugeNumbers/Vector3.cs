...
{
    /// <summary>
    /// A structure encapsulating three HugeNumber precision floating point values.
    /// </summary>
    /// <remarks>
    ...
    public struct Vector3 : IEquatable<Vector3>, IComparable, IComparable<Vector3>, IFormattable
    {
        ...
        public Vector3(HugeNumber value) : this(value, value, value) { }
        ...
        public Vector3(Vector2 value, HugeNumber z) : this(value.X, value.Y, z) { }
        ...
        public Vector3(HugeNumber x, HugeNumber y, HugeNumber z)
        {
            X = x;
            Y = y;
            Z = z;
        ...
        public static Vector3 Abs(Vector3 value)
            => new(HugeNumber.Abs(value.X), HugeNumber.Abs(value.Y), HugeNumber.Abs(value.Z));
        ...
        public static HugeNumber Angle(Vector3 value1, Vector3 value2)
            => HugeNumber.Atan2(Cross(value1, value2).Length(), Dot(value1, value2));
        ...
        public static HugeNumber Distance(Vector3 value1, Vector3 value2)
        ...
        public static HugeNumber DistanceSquared(Vector3 value1, Vector3 value2)
        {
        ...
        public static HugeNumber Dot(Vector3 vector1, Vector3 vector2)
            => (vector1.X * vector2.X)
            + (vector1.Y * vector2.Y)
            + (vector1.Z * vector2.Z);
        ...
        /// <returns><see langword="true"/> if the vector is zero; otherwise <see
        /// langword="false"/>.</returns>
        public static bool IsZero(Vector3 value) => value.X == 0 && value.Y == 0 && value.Z == 0;
        ...
        public static Vector3 Lerp(Vector3 value1, Vector3 value2, HugeNumber amount)
            => new(
        ...
        public static Quaternion RotationTo(Vector3 value1, Vector3 value2)
        {
            ...
            else
            {
                return Quaternion.Normalize(
                    new Quaternion(
                        Cross(value1, value2),
                        HugeNumber.Sqrt(value1.LengthSquared() * value2.LengthSquared()) + Dot(value1, value2)));
            }
        }
        ...
        public static Vector3 SquareRoot(Vector3 value)
            => new(value.X.Sqrt(), value.Y.Sqrt(), value.Z.Sqrt());
        ...
        /// <returns>The angle between the vectors, in radians.</returns>
        public HugeNumber Angle(Vector3 other) => Angle(this, other);
        ...
        public void CopyTo(HugeNumber[] array) => CopyTo(array, 0);
        ...
        public void CopyTo(HugeNumber[] array, int index)
        {
            if (array is null)
            {
        ...
        /// <returns>The distance.</returns>
        public HugeNumber Distance(Vector3 other) => Distance(this, other);
        ...
        /// <param name="other">The second point.</param>
        /// <returns>The distance squared.</returns>
        public HugeNumber DistanceSquared(Vector3 other) => DistanceSquared(this, other);
        ...
        /// <param name="other">The second vector.</param>
        /// <returns>The dot product.</returns>
        public HugeNumber Dot(Vector3 other) => Dot(this, other);
        ...
        public HugeNumber LengthSquared() => (X * X) + (Y * Y) + (Z * Z);
        ...
        public override string ToString() => ToString("G", HugeNumberFormatProvider.Instance);
        ...
        /// <returns>The string representation.</returns>
        public string ToString(string format) => ToString(format, HugeNumberFormatProvider.Instance);
        ...
        public static Vector3 Multiply(Vector3 left, HugeNumber right) => left * right;
        ...
        /// <returns>The scaled vector.</returns>
        public static Vector3 Multiply(HugeNumber left, Vector3 right) => left * right;
        ...
        public static Vector3 Divide(Vector3 left, HugeNumber divisor) => left / divisor;
        ...
        /// <param name="right">The scalar value.</param>
        /// <returns>The scaled vector.</returns>
        public static Vector3 operator *(Vector3 left, HugeNumber right)
        ...
        /// <param name="right">The source vector.</param>
        /// <returns>The scaled vector.</returns>
        public static Vector3 operator *(HugeNumber left, Vector3 right)
        ...
        /// <returns>The result of the division.</returns>
        public static Vector3 operator /(Vector3 value1, HugeNumber value2)
        ...
        /// </summary>
        /// <param name="value">The value to convert.</param>
        public static implicit operator Vector3(Doubles.Vector3 value)
            => new(value.X, value.Y, value.Z);
        ...
        public static explicit operator Vector3(Decimals.Vector3 value)
            => new((HugeNumber)value.X, (HugeNumber)value.Y, (HugeNumber)value.Z);
