...
{
    /// <summary>
    /// A structure encapsulating four HugeNumber precision floating point values.
    /// </summary>
    /// <remarks>
    ...
    public struct Vector4 : IEquatable<Vector4>, IComparable, IComparable<Vector4>, IFormattable
    {
        ...
        public Vector4(HugeNumber value) : this(value, value, value, value) { }
        ...
        public Vector4(HugeNumber x, HugeNumber y, HugeNumber z, HugeNumber w)
        {
            W = w;
            X = x;
            Y = y;
        ...
        public Vector4(Vector2 value, HugeNumber z, HugeNumber w)
        {
            X = value.X;
            Y = value.Y;
            Z = z;
        ...
        /// <param name="w">The W component.</param>
        public Vector4(Vector3 value, HugeNumber w)
        {
            X = value.X;
            Y = value.Y;
            Z = value.Z;
        ...
        public static Vector4 Abs(Vector4 value)
            => new(HugeNumber.Abs(value.X), HugeNumber.Abs(value.Y), HugeNumber.Abs(value.Z), HugeNumber.Abs(value.W));
        ...
        public static HugeNumber Distance(Vector4 value1, Vector4 value2)
        ...
        public static HugeNumber DistanceSquared(Vector4 value1, Vector4 value2)
        {
        ...
        public static HugeNumber Dot(Vector4 vector1, Vector4 vector2)
            => (vector1.X * vector2.X)
            + (vector1.Y * vector2.Y)
            + (vector1.Z * vector2.Z)
            + (vector1.W * vector2.W);
        ...
        public static Vector4 Lerp(Vector4 value1, Vector4 value2, HugeNumber amount)
            => new(
        ...
        /// <returns>The distance.</returns>
        public HugeNumber Distance(Vector4 other) => Distance(this, other);
        ...
        /// <param name="other">The second point.</param>
        /// <returns>The distance squared.</returns>
        public HugeNumber DistanceSquared(Vector4 other) => DistanceSquared(this, other);
        ...
        /// <returns>The dot product.</returns>
        public HugeNumber Dot(Vector4 other) => Dot(this, other);
        ...
        public static Vector4 Multiply(Vector4 left, HugeNumber right) => left * right;
        ...
        /// <returns>The scaled vector.</returns>
        public static Vector4 Multiply(HugeNumber left, Vector4 right) => left * right;
        ...
        public static Vector4 Divide(Vector4 left, HugeNumber divisor) => left / divisor;
        ...
        /// <param name="right">The scalar value.</param>
        /// <returns>The scaled vector.</returns>
        public static Vector4 operator *(Vector4 left, HugeNumber right)
        ...
        /// <param name="right">The source vector.</param>
        /// <returns>The scaled vector.</returns>
        public static Vector4 operator *(HugeNumber left, Vector4 right)
        ...
        /// <returns>The result of the division.</returns>
        public static Vector4 operator /(Vector4 value1, HugeNumber value2)
        ...
        /// </summary>
        /// <param name="value">The value to convert.</param>
        public static implicit operator Vector4(Doubles.Vector4 value)
            => new(value.X, value.Y, value.Z, value.W);
        ...
        /// </summary>
        /// <param name="value">The value to convert.</param>
        public static explicit operator Vector4(Decimals.Vector4 value)
